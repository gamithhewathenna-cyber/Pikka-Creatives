...
<div class="card">
  ...
  <p class="sub">Manage everything on the Pikka Creatives home page from here. Pick a section on the left to edit its content.</p>
...
<div class="card">
  ...
  <div style="display:flex;gap:10px;flex-wrap:wrap">
    <a class="btn btn-ghost btn-sm" href="sections.php">Edit section text</a>
    <a class="btn btn-ghost btn-sm" href="images.php">Change images</a>
    <a class="btn btn-ghost btn-sm" href="services.php">Edit services</a>
